# Design Test Rapport — Dashboard v0.21.0

| | |
|---|---|
| **Dashboard versie** | `0.21.0` |
| **Datum** | 07-03-2026 16:38:35 |
...
- ✗ **T1.1 Ontbrekende tokens: --font-weight-regular, --font-weight-medium, --font-weight-semibold…** — `6 ontbrekend`
...
- ✗ **T5.1 Rijhoogte** — `143104px (verwacht 32px), 1 rijen`
...
- △ **T7.2 Gekleurde avatars** — `18 van 84`
...
- ✗ **Rijhoogte afwijkend** — `143104px op 1 rijen`
- △ **Toolbar hoogte** — `50px`
...
*Gegenereerd door Design Test Runner — Dashboard v0.21.0*