# Dashboard Test Rapport — v0.42.0

| | |
|---|---|
| **Dashboard versie** | `0.42.0` |
| **Datum** | 08-03-2026 16:21:06 |
...
- ✓ **B-I3 Filter toepassen** — `929/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=302 OR=2152`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=68898`
...
- ✓ **D-P1 first-paint: 36ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 36ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `91ms`
...
*Gegenereerd door Dashboard Test Runner — v0.42.0*