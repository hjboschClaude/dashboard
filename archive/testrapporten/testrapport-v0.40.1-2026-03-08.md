# Dashboard Test Rapport — v0.40.1

| | |
|---|---|
| **Dashboard versie** | `0.40.1` |
| **Datum** | 08-03-2026 15:50:43 |
...
- ✓ **B-I3 Filter toepassen** — `917/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=307 OR=2098`
...
- ✓ **D-L5 computeAggModel** — `4.8ms`
- ✓ **D-L6 renderVirtualBody** — `3.4ms`
- ✓ **D-L7 Full render cycle** — `22.6ms`
...
*Gegenereerd door Dashboard Test Runner — v0.40.1*