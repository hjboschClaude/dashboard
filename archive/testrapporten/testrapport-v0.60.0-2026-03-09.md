# Dashboard Test Rapport — v0.60.0

| | |
|---|---|
| **Dashboard versie** | `0.60.0` |
| **Datum** | 09-03-2026 12:23:52 |
...
- ✓ **B-I3 Filter toepassen** — `885/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=310 OR=2086`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=66786`
- ✓ **B-I16 DOM nodes** — `4324 nodes`
...
- ✓ **D-P1 first-paint: 164ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 164ms** — `budget: <500ms`
- ○ **D-P2 total-init** — `mark niet gevonden`
- ✓ **D-P3 dashboard:ready** — `mark aanwezig`

### D-C — CSS & design metrics

- ✓ **D-C1 CSS regelcount** — `294 regels`
- ✓ **D-C2 CSS grootte** — `32.2 KB`
- ✓ **D-C3 Design tokens ≤ 42** — `42 tokens`
- ✓ **D-C4 Unieke font-sizes** — `4 (11px, 12px, 14px, 20px)`
- ✓ **D-C5 Off-grid padding** — `0 afwijkingen`

### D-M — DOM & geheugen

- △ **D-M1 DOM nodes** — `4114 (drempel: <3000)`
...
- ✓ **D-L1 Hover reflow** — `0.1ms`
- ✓ **D-L2 computeFilteredData** — `0ms`
- ✓ **D-L3 sortData** — `4.8ms`
- ✓ **D-L4 groupData** — `0.6ms`
- ✓ **D-L5 computeAggModel** — `4.9ms`
- ✓ **D-L6 renderVirtualBody** — `4ms`
- ✓ **D-L7 Full render cycle** — `24.8ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `15000 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.60.0*