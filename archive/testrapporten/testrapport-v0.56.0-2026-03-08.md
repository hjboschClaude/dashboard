# Dashboard Test Rapport — v0.56.0

| | |
|---|---|
| **Dashboard versie** | `0.56.0` |
| **Datum** | 08-03-2026 23:17:40 |
...
- ✓ **B-I3 Filter toepassen** — `886/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=279 OR=2092`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=66978`
- ✓ **B-I16 DOM nodes** — `4391 nodes`
...
- ✓ **D-P1 first-paint: 44ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 44ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `116ms`
...
- △ **D-M1 DOM nodes** — `4181 (drempel: <3000)`
- ✓ **D-M2 Virtualisatie actief** — `28 DOM-rijen`
- ✓ **D-M3 JS heap** — `9.5 MB`
- ✓ **D-M4 Avatar cache** — `56 entries`
...
- ✓ **D-L5 computeAggModel** — `4.4ms`
- ✓ **D-L6 renderVirtualBody** — `3.3ms`
- ✓ **D-L7 Full render cycle** — `25ms`
...
*Gegenereerd door Dashboard Test Runner — v0.56.0*