# Dashboard Test Rapport — v0.47.0

| | |
|---|---|
| **Dashboard versie** | `0.47.0` |
| **Datum** | 08-03-2026 19:47:20 |
...
- ✓ **B-I3 Filter toepassen** — `889/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=306 OR=2067`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=66178`
...
- ✓ **D-P1 first-paint: 276ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 276ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `448ms`
...
- ✓ **D-S2 Scroll FPS** — `7895 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.47.0*