# Dashboard Test Rapport — v0.48.0

| | |
|---|---|
| **Dashboard versie** | `0.48.0` |
| **Datum** | 08-03-2026 19:57:49 |
...
- ✓ **B-I3 Filter toepassen** — `913/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=303 OR=2080`
...
- ✓ **D-L7 Full render cycle** — `31ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `30000 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.48.0*