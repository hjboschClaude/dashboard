# Design Test Rapport — Dashboard v0.18.0

| | |
|---|---|
| **Dashboard versie** | `0.18.0` |
| **Datum** | 07-03-2026 15:54:24 |
...
- ✗ **T5.1 Rijhoogte** — `34px (verwacht 32px), 4500 rijen`
...
- △ **T7.2 Gekleurde avatars** — `9543 van 13500`
...
- ✗ **Rijhoogte afwijkend** — `34px op 4500 rijen`
- △ **Toolbar hoogte** — `50px`
...
- ✓ **P1 first-paint: 204ms** — `snel`
- ✓ **P1 first-contentful-paint: 204ms** — `snel`
...
*Gegenereerd door Design Test Runner — Dashboard v0.18.0*