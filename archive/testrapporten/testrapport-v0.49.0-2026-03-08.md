# Dashboard Test Rapport — v0.49.0

| | |
|---|---|
| **Dashboard versie** | `0.49.0` |
| **Datum** | 08-03-2026 20:06:49 |
...
- ✓ **B-I3 Filter toepassen** — `859/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=301 OR=2073`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=66370`
...
- ✓ **D-L5 computeAggModel** — `4.1ms`
- ✓ **D-L6 renderVirtualBody** — `2.9ms`
- ✓ **D-L7 Full render cycle** — `31.4ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `300000 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.49.0*