# Dashboard Test Rapport — v0.39.1

| | |
|---|---|
| **Dashboard versie** | `0.39.1` |
| **Datum** | 08-03-2026 15:22:21 |
...
- ✓ **B-I3 Filter toepassen** — `878/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=293 OR=2085`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=66754`
...
- ✓ **D-P1 first-paint: 96ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 96ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `220ms`
...
- △ **D-L1 Hover reflow** — `27.5ms (drempel: <2ms)`
- ✓ **D-L2 computeFilteredData** — `0ms`
- ✓ **D-L3 sortData** — `8.7ms`
- ✓ **D-L4 groupData** — `0.8ms`
- ✓ **D-L5 computeAggModel** — `6.1ms`
- ✓ **D-L6 renderVirtualBody** — `4.8ms`
- ✓ **D-L7 Full render cycle** — `51.5ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `100000 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.39.1*