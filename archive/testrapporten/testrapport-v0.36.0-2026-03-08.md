# Dashboard Test Rapport — v0.36.0

| | |
|---|---|
| **Dashboard versie** | `0.36.0` |
| **Datum** | 08-03-2026 14:43:16 |
...
- ✓ **VC-5.1 Rijhoogte 32px** — `28 rijen`
...
- ✓ **D-P1 first-paint: 88ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 88ms** — `budget: <500ms`
...
- ✓ **D-P2a Load tijd** — `68ms`
- ✓ **D-P2b DOM gereed** — `61ms`
- ✓ **D-M3 JS heap** — `9.5 MB`
- ✓ **D-M1 DOM nodes** — `2362 nodes`

### D-L — Interactie & stabiliteit

- △ **D-L1 Hover reflow latency** — `5.1ms (drempel: <2ms)`
- ✓ **D-S2 Scroll FPS** — `23077 fps (budget: ≥45)`

---

*Gegenereerd door Dashboard Test Runner — v0.36.0*