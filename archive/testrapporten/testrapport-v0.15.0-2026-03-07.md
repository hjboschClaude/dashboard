# Design Test Rapport — Dashboard v0.15.0

| | |
|---|---|
| **Dashboard versie** | `0.15.0` |
| **Datum** | 07-03-2026 15:24:45 |
...
- △ **T2.3 Verboden font-sizes** — `16px×7, 13px×27, 9px×25, 22px×6`
...
- △ **T7.2 Gekleurde avatars** — `31 van 36`
...
- ✓ **P1 first-paint: 312ms** — `snel`
- ✓ **P1 first-contentful-paint: 312ms** — `snel`
...
*Gegenereerd door Design Test Runner — Dashboard v0.15.0*