# Design Test Rapport — Dashboard v0.34.0

| | |
|---|---|
| **Dashboard versie** | `0.34.0` |
| **Datum** | 07-03-2026 20:16:25 |
...
- △ **T2.3 Verboden font-sizes** — `16px×7`
...
- ✓ **P4 Unieke font-sizes ≤ 6** — `11px, 12px, 14px, 16px, 18px, 20px`
...
*Gegenereerd door Design Test Runner — Dashboard v0.34.0*