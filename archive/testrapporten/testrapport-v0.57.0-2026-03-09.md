# Dashboard Test Rapport — v0.57.0

| | |
|---|---|
| **Dashboard versie** | `0.57.0` |
| **Datum** | 09-03-2026 07:25:15 |
...
- ✓ **B-I3 Filter toepassen** — `935/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=308 OR=2097`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=67138`
...
- ✓ **D-L3 sortData** — `5ms`
- ✓ **D-L4 groupData** — `0.8ms`
- ✓ **D-L5 computeAggModel** — `3.6ms`
- ✓ **D-L6 renderVirtualBody** — `2.9ms`
- ✓ **D-L7 Full render cycle** — `20.9ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `18750 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.57.0*