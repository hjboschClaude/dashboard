# Dashboard Test Rapport — v0.59.0

| | |
|---|---|
| **Dashboard versie** | `0.59.0` |
| **Datum** | 09-03-2026 10:08:33 |
...
- ✓ **B-I3 Filter toepassen** — `887/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=307 OR=2106`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=67426`
...
- ✓ **D-P1 first-paint: 392ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 392ms** — `budget: <500ms`
...
- ✓ **D-L3 sortData** — `12.3ms`
- ✓ **D-L4 groupData** — `1.4ms`
- ✓ **D-L5 computeAggModel** — `9.3ms`
- ✓ **D-L6 renderVirtualBody** — `6.6ms`
- ✓ **D-L7 Full render cycle** — `47.5ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `37500 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.59.0*