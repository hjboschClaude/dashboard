# Dashboard Test Rapport — v0.52.0

| | |
|---|---|
| **Dashboard versie** | `0.52.0` |
| **Datum** | 08-03-2026 20:41:03 |
...
- ✓ **B-I3 Filter toepassen** — `897/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=308 OR=2054`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=65762`
...
*Gegenereerd door Dashboard Test Runner — v0.52.0*