# Dashboard Test Rapport — v0.50.0

| | |
|---|---|
| **Dashboard versie** | `0.50.0` |
| **Datum** | 08-03-2026 20:17:33 |
...
- ✓ **B-I3 Filter toepassen** — `919/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=295 OR=2117`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=67778`
...
- ✓ **D-P1 first-paint: 252ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 252ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `387ms`
...
*Gegenereerd door Dashboard Test Runner — v0.50.0*