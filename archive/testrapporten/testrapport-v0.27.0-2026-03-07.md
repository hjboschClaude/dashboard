# Design Test Rapport — Dashboard v0.27.0

| | |
|---|---|
| **Dashboard versie** | `0.27.0` |
| **Datum** | 07-03-2026 17:48:58 |
...
- ✓ **T2.1b th uppercase**
- ○ **T2.2 .cell-primary** — `element niet gevonden`
- △ **T2.3 Verboden font-sizes** — `16px×7, 13px×27, 9px×24, 22px×6`
...
- ✗ **T5.1 Rijhoogte** — `52px (verwacht 32px), 22 rijen`
- △ **T5.2 Toolbar hoogte** — `54px (verwacht 36-44px)`
...
- △ **T7.2 Gekleurde avatars** — `50 van 66`
...
- ✗ **Rijhoogte afwijkend** — `52px op 22 rijen`
- △ **Toolbar hoogte** — `54px`
...
*Gegenereerd door Design Test Runner — Dashboard v0.27.0*