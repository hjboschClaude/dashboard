# Dashboard Test Rapport — v0.39.0

| | |
|---|---|
| **Dashboard versie** | `0.39.0` |
| **Datum** | 08-03-2026 15:14:16 |
...
- ✓ **B-I5 Filter AND/OR** — `AND=295 OR=2123`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=67970`
...
- ✓ **D-P1 first-paint: 324ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 324ms** — `budget: <500ms`
- ✗ **D-P2 total-init** — `606ms (drempel: <300ms)`
...
- △ **D-M1 DOM nodes** — `4500 (drempel: <3000)`
...
- △ **D-L1 Hover reflow** — `33.9ms (drempel: <2ms)`
- ✓ **D-L2 computeFilteredData** — `0.1ms`
- ✓ **D-L3 sortData** — `9.5ms`
- ✓ **D-L4 groupData** — `1.2ms`
- ✓ **D-L5 computeAggModel** — `7.3ms`
- ✓ **D-L6 renderVirtualBody** — `5.2ms`
- ✓ **D-L7 Full render cycle** — `34.3ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `75000 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.39.0*