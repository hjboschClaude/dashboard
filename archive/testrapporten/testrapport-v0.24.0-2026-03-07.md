# Design Test Rapport — Dashboard v0.24.0

| | |
|---|---|
| **Dashboard versie** | `0.24.0` |
| **Datum** | 07-03-2026 17:12:42 |
...
- ✓ **P1 first-paint: 164ms** — `snel`
- ✓ **P1 first-contentful-paint: 164ms** — `snel`
...
*Gegenereerd door Design Test Runner — Dashboard v0.24.0*