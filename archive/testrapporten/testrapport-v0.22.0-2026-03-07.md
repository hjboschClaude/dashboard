# Design Test Rapport — Dashboard v0.22.0

| | |
|---|---|
| **Dashboard versie** | `0.22.0` |
| **Datum** | 07-03-2026 16:50:36 |
...
- ✓ **P1 first-paint: 176ms** — `snel`
- ✓ **P1 first-contentful-paint: 176ms** — `snel`
...
- ✓ **P7a Load tijd** — `133ms`
- ✓ **P7b DOM gereed** — `131ms`
- ✓ **P8 JS heap** — `9.5 MB`
- ✓ **P9a DOM nodes** — `2480 nodes`
...
*Gegenereerd door Design Test Runner — Dashboard v0.22.0*