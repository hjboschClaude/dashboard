# Dashboard Test Rapport — v0.38.0

| | |
|---|---|
| **Dashboard versie** | `0.38.0` |
| **Datum** | 08-03-2026 15:01:30 |
...
- △ **VC-2.4 Verboden font-sizes** — `36px×1`
- ✓ **VC-2.5 Unieke font-sizes ≤ 6** — `11px, 12px, 14px, 18px, 20px, 36px`
...
- ✗ **VC-5.1 Rijhoogte** — `0px, 1 afwijkend`
...
- ✓ **VC-7.2 Avatars monochroom** — `84 avatars`
...
- ✓ **B-I5 Filter AND/OR** — `AND=296 OR=2081`
...
- ✓ **B-I14 Virtual scroll** — `29 DOM vs 4500 data`
- ✓ **B-I15 Container scrollbaar** — `scrollH=66626`
- ✓ **B-I16 DOM nodes** — `2492 nodes`

### B-I17/I18 — Context & panels

- △ **B-I17 Context menu element** — `niet gevonden`
...
- ✓ **D-P1 first-paint: 344ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 344ms** — `budget: <500ms`
...
- ✓ **D-P2a Load tijd** — `309ms`
- ✓ **D-P2b DOM gereed** — `306ms`
- ✓ **D-M3 JS heap** — `9.5 MB`
- △ **D-M1 DOM nodes** — `4226 (drempel: <3000)`

### D-L — Interactie & stabiliteit

- ✓ **D-L1 Hover reflow latency** — `1.4ms`
- ✓ **D-S2 Scroll FPS** — `100000 fps (budget: ≥45)`

---

*Gegenereerd door Dashboard Test Runner — v0.38.0*