# Dashboard Test Rapport — v0.44.0

| | |
|---|---|
| **Dashboard versie** | `0.44.0` |
| **Datum** | 08-03-2026 19:03:57 |
...
- ✓ **B-I3 Filter toepassen** — `928/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=321 OR=2098`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=67170`
...
- ✓ **D-P1 first-paint: 196ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 196ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `308ms`
...
*Gegenereerd door Dashboard Test Runner — v0.44.0*