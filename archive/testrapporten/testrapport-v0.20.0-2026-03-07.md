# Design Test Rapport — Dashboard v0.20.0

| | |
|---|---|
| **Dashboard versie** | `0.20.0` |
| **Datum** | 07-03-2026 16:30:38 |
...
- ✗ **T5.1 Rijhoogte** — `34px (verwacht 32px), 30 rijen`
...
- △ **T7.2 Gekleurde avatars** — `53 van 87`
...
- ✗ **Rijhoogte afwijkend** — `34px op 30 rijen`
- △ **Toolbar hoogte** — `50px`
...
- ✓ **P1 first-paint: 480ms** — `snel`
- ✓ **P1 first-contentful-paint: 480ms** — `snel`
- ✓ **P2a CSS regelcount** — `290 regels`
- ✓ **P2b CSS grootte** — `33 KB`
...
- ✓ **P7a Load tijd** — `418ms`
- ✓ **P7b DOM gereed** — `417ms`
- ✓ **P8 JS heap** — `9.5 MB`
- ✓ **P9a DOM nodes** — `2485 nodes`
...
*Gegenereerd door Design Test Runner — Dashboard v0.20.0*