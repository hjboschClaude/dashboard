# Dashboard Test Rapport — v0.45.0

| | |
|---|---|
| **Dashboard versie** | `0.45.0` |
| **Datum** | 08-03-2026 19:15:54 |
...
- ✓ **B-I3 Filter toepassen** — `923/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=325 OR=2045`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=65474`
...
- ✓ **D-P1 first-paint: 248ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 248ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `369ms`
...
- ✓ **D-L5 computeAggModel** — `4.2ms`
- ✓ **D-L6 renderVirtualBody** — `3.1ms`
- ✓ **D-L7 Full render cycle** — `21.6ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `23077 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.45.0*