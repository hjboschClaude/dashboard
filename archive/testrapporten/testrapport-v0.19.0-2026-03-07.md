# Design Test Rapport — Dashboard v0.19.0

| | |
|---|---|
| **Dashboard versie** | `0.19.0` |
| **Datum** | 07-03-2026 16:27:38 |
...
- ✗ **T5.1 Rijhoogte** — `34px (verwacht 32px), 29 rijen`
...
- △ **T7.2 Gekleurde avatars** — `84 van 84`
...
- ✗ **Rijhoogte afwijkend** — `34px op 29 rijen`
- △ **Toolbar hoogte** — `50px`
...
*Gegenereerd door Design Test Runner — Dashboard v0.19.0*