# Dashboard Test Rapport — v0.51.0

| | |
|---|---|
| **Dashboard versie** | `0.51.0` |
| **Datum** | 08-03-2026 20:28:51 |
...
- ✓ **B-I3 Filter toepassen** — `903/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=328 OR=2057`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=65858`
...
- ✓ **D-P1 first-paint: 240ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 240ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `360ms`
...
- ✓ **D-L7 Full render cycle** — `20.4ms`

### D-S — Stabiliteit

- ✓ **D-S1 LongTasks bij init** — `0 events`
- ✓ **D-S2 Scroll FPS** — `33333 fps (budget: ≥45)`
- ✓ **D-S3 Scroll listeners** — `2 gebonden containers`
- ✓ **D-S4 Console errors** — `0 errors`

---

*Gegenereerd door Dashboard Test Runner — v0.51.0*