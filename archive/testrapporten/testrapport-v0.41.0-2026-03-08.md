# Dashboard Test Rapport — v0.41.0

| | |
|---|---|
| **Dashboard versie** | `0.41.0` |
| **Datum** | 08-03-2026 16:03:08 |
...
- ✓ **B-I5 Filter AND/OR** — `AND=320 OR=2061`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=65986`
...
- ✓ **D-P1 first-paint: 60ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 60ms** — `budget: <500ms`
- ✓ **D-P2 total-init** — `172ms`
- ✓ **D-P3 dashboard:ready** — `mark aanwezig`

### D-C — CSS & design metrics

- ✓ **D-C1 CSS regelcount** — `293 regels`
- ✓ **D-C2 CSS grootte** — `32.9 KB`
- △ **D-C3 Design tokens** — `76 (doel: ≤42)`
...
- ✓ **D-L3 sortData** — `5.3ms`
- ✓ **D-L4 groupData** — `1ms`
- ✓ **D-L5 computeAggModel** — `6.9ms`
- ✓ **D-L6 renderVirtualBody** — `4.3ms`
- ✓ **D-L7 Full render cycle** — `20ms`
...
*Gegenereerd door Dashboard Test Runner — v0.41.0*