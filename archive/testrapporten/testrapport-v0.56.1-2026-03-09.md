# Dashboard Test Rapport — v0.56.1

| | |
|---|---|
| **Dashboard versie** | `0.56.1` |
| **Datum** | 09-03-2026 07:02:46 |
...
- ✓ **B-I3 Filter toepassen** — `901/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=300 OR=2065`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=66114`
...
- ✓ **D-P1 first-paint: 32ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 32ms** — `budget: <500ms`
...
*Gegenereerd door Dashboard Test Runner — v0.56.1*