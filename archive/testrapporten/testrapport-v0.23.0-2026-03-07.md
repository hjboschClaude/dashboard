# Design Test Rapport — Dashboard v0.23.0

| | |
|---|---|
| **Dashboard versie** | `0.23.0` |
| **Datum** | 07-03-2026 17:02:29 |
...
- ✓ **P1 first-paint: 156ms** — `snel`
- ✓ **P1 first-contentful-paint: 156ms** — `snel`
...
*Gegenereerd door Design Test Runner — Dashboard v0.23.0*