# Design Test Rapport — Dashboard v0.25.0

| | |
|---|---|
| **Dashboard versie** | `0.25.0` |
| **Datum** | 07-03-2026 17:21:47 |
...
- ✗ **T5.1 Rijhoogte** — `0px (verwacht 32px), 1 rijen`
...
- △ **T7.2 Gekleurde avatars** — `41 van 87`
...
- ✗ **Rijhoogte afwijkend** — `0px op 1 rijen`
- △ **Toolbar hoogte** — `50px`
...
*Gegenereerd door Design Test Runner — Dashboard v0.25.0*