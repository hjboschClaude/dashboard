# Design Test Rapport — Dashboard v0.28.0

| | |
|---|---|
| **Dashboard versie** | `0.28.0` |
| **Datum** | 07-03-2026 18:09:18 |
...
- △ **T7.2 Gekleurde avatars** — `54 van 81`
...
- ✓ **P1 first-paint: 60ms** — `snel`
- ✓ **P1 first-contentful-paint: 60ms** — `snel`
- ✓ **P2a CSS regelcount** — `292 regels`
...
*Gegenereerd door Design Test Runner — Dashboard v0.28.0*