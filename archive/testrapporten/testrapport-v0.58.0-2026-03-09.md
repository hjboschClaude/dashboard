# Dashboard Test Rapport — v0.58.0

| | |
|---|---|
| **Dashboard versie** | `0.58.0` |
| **Datum** | 09-03-2026 08:15:25 |
...
- ✓ **B-I3 Filter toepassen** — `933/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=313 OR=2159`
...
- ✓ **B-I10 Groep inklappen** — `groep "Gepland" ingeklapt`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=69122`
...
- ✓ **D-P1 first-paint: 40ms** — `budget: <500ms`
- ✓ **D-P1 first-contentful-paint: 40ms** — `budget: <500ms`
