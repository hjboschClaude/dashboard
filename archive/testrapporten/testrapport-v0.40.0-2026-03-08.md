# Dashboard Test Rapport — v0.40.0

| | |
|---|---|
| **Dashboard versie** | `0.40.0` |
| **Datum** | 08-03-2026 15:40:14 |
...
- △ **VC-1.4 Aliassen ontbreken** — `--surface2, --surface3, --border-hover, --accent2, --accent3`
...
- ✓ **B-I3 Filter toepassen** — `875/4500 rijen`
- ✓ **B-I4 Filter verwijderen** — `4500 rijen hersteld`
- ✓ **B-I5 Filter AND/OR** — `AND=302 OR=2118`
...
- ✓ **B-I15 Container scrollbaar** — `scrollH=67810`
...
*Gegenereerd door Dashboard Test Runner — v0.40.0*